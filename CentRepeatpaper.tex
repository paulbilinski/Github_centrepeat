...
While the approach appears to work well for animals, the method has known problems when working with plants.
...
The topology varies slighty between studies, as some nodes are collapsed into polytomies.\jri{do they agree? is wu 2012 part of wu-tang?}\pb{nothing in phylogenetics ever agrees and includes all of our exact species.  thats why i went to make my own.}
...
\pb{Jeff, I played around with finding a good way to represent homology across the repeats, but think the figure would be super clunky, and potentially more confusing.  I will draw out a sketch of what it might look like in notability and send that to you, maybe.  As you can tell, I go back and forth as to whether I hate this figure or think it is useful...}
...
Altogether, we see both rapid turnover and retention of high abundance tandem repeats across our taxanomic sampling.
...
While far from sufficient to make evolutionary claims about the origin of functionally important tandem repeats \jri{wait you just did}\pb{JRIHELP response to both, how do i state this to be sufficiently vague, but still suggest that this is the road you can go down when you have a consensus repeat for all tips in a phylogeny}, the identification of novel repeats in previously unstudied organisms has the potential to produce phylogentically relevant data from repetitive content.\jri{lame sentence. bring a lotta data? big deal.}
