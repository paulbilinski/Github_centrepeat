...
\begin{flushleft}
{\Large
\textbf\newline{We found knobs wooo. Bioinformatic analyses of genomic composition of tandem repeats in grasses %Applications and Limiations of De-Novo Centromeric Repeat Assembly in Grasses
}
}
\newline
...
Genomic abundance was not predictive of centromere localization within the three novel repeats that were examined through FISH.\pb{I hated each possible way to represent this clusterf.  Do we need a homology figure if it kinda just muddles things (in my opinion)?}
