...
While far from sufficient to make evolutionary claims about the origin of functionally important tandem repeats %\jri{wait you just did}\pb{JRIHELP response to both, how do i state this to be sufficiently vague, but still suggest that this is the road you can go down when you have a consensus repeat for all tips in a phylogeny}, 
the identification of novel repeats in previously unstudied organisms has the potential to produce phylogentically relevant data from repetitive content.%\jri{lame sentence. bring a lotta data? big deal.}
